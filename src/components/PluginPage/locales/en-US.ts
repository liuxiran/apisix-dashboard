 ...
 */
export default {
  'component.pluginPage.pluginCard.limit-conn.description':
  ...
  'component.pluginPage.pluginCard.limit-count.description':
    'Limit the total requests within the specified time range',
  'PluginPage.card.limit-count.property.count': 'Total requests',
  'PluginPage.card.limit-count.property.count.extra':
    'Threshold for the number of requests within a specified time window',
  ...
  'PluginPage.card.limit-count.property.redis_host.extra':
    'Redis node address for cluster flow limited',
  ...
  'component.pluginPage.pluginCard.limit-req.description':
    'A plugin which is base leaky bucket algorithm to limit the speed of requests',
  ...
  'component.pluginPage.pluginCard.cors.description':
    'The CORS plugin can enable the return header of CORS for the server',
  ...
  'component.pluginPage.pluginCard.fault-injection.description':
    'Fault-injection plugin used to simulate various backend failures and high latency',
  ...
  'component.pluginPage.pluginCard.http-logger.description':
    'http-logger can push log data requests to the HTTP/HTTPS server',
  'PluginPage.card.http-logger.property.uri': 'log server address',
  'PluginPage.card.http-logger.property.uri.extra':
    'For example: 127.0.0.1:80/postendpoint?param=1',

  'component.pluginPage.pluginCard.ip-restriction.description':
  ...
  'component.pluginPage.pluginCard.kafka-logger.description':
    'Push the interface request logs as JSON to the external Kafka clusters',
  'PluginPage.card.kafka-logger.property.broker_list': 'broker',
  'PluginPage.card.kafka-logger.property.kafka_topic': 'topic',

  'component.pluginPage.pluginCard.prometheus.description':
    'Provide metrics data which is accord with prometheus data formate',

  'component.pluginPage.pluginCard.proxy-cache.description':
    'Proxy-cache plugin can cache the response data of the backend service',
  ...
  'component.pluginPage.pluginCard.proxy-mirror.description':
    'Proxy-mirror plugin provides the ability to mirror client',
  ...
  'component.pluginPage.pluginCard.response-rewrite.description':
    'The plugin supports modifying the body and header information returned by the upstream service',
  ...
  'PluginPage.card.response-rewrite.property.body_base64':
    'Whether the response body requires base64 decoding',
  'PluginPage.card.response-rewrite.property.headers': 'HTTP header',

  'component.pluginPage.pluginCard.syslog.description': 'Relate to the syslog log server',
  ...
  'component.pluginPage.pluginCard.tcp-logger.description': 'Relate to the TCP log server',
  ...
  'component.pluginPage.pluginCard.udp-logger.description': 'Relate to the UDP log server',
  ...
  'component.pluginPage.pluginCard.zipkin.description': 'Relate to zipkin',
  'PluginPage.card.zipkin.property.endpoint': 'endpoint',
  'PluginPage.card.zipkin.property.endpoint.extra':
    'For example: http://127.0.0.1:9411/api/v2/spans',
  ...
  'PluginPage.card.zipkin.property.server_addr.extra':
    'default value is Nginx variable server_addr',

  'component.pluginPage.pluginCard.skywalking.description': 'Relate to Apache Skywalking',
  ...
  'component.pluginPage.pluginCard.serverless-pre-function.description':
    'Runs the specified Lua function at the beginning of the specified phase',
  ...
  'component.pluginPage.pluginCard.serverless-post-function.description':
    'Runs the specified Lua function at the ending of the specified phase',
  ...
  'component.pluginPage.pluginCard.basic-auth.description': 'basic auth plugin',
  'component.pluginPage.pluginCard.jwt-auth.description': 'JWT authentication plugin',
  'component.pluginPage.pluginCard.key-auth.description': 'key auth plugin',
  'component.pluginPage.pluginCard.wolf-rbac.description': 'Relate to wolf RBAC service',
  'component.pluginPage.pluginCard.openid-connect.description':
    'Open ID Connect(OIDC) plugin provide the ability to deal with external certification services',

  'component.pluginPage.pluginCard.redirect.description': 'redirect plugin',
  'component.pluginPage.pluginCard.proxy-rewrite.description':
    'proxy rewrite plugin, which can rewrite client request',
  'component.pluginPage.pluginCard.mqtt-proxy.description':
    'mqtt-proxy plugin can achieve load balancing based on client_id of MQTT',
  'component.pluginPage.pluginCard.grpc-transcoding.description':
    'gRPC transform plugin can achieve HTTP(s) -> APISIX -> gRPC server',
  'component.pluginPage.pluginCard.batch-requests.description':
  ...
  'component.pluginPage.pluginCard.node-status.description': 'node-status',
  'component.pluginPage.pluginCard.defaultMessage': 'Please refer to the official documents',

  'component.pluginPage.drawer.title.configurePlugin': 'Configure plugin',
  'component.pluginPage.button.disable': 'Disable',
  'component.pluginPage.button.enable': 'Enable',
  'component.pluginPage.panelSection.title.isEnabled': 'Is Enabled',
  'component.pluginPage.panelSection.title.notEnabled': 'Not Enabled',
};
