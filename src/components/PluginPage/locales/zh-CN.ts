 ...
 */
export default {
  'component.pluginPage.pluginCard.limit-conn.description': '限制并发连接数',
  ...
  'component.pluginPage.pluginCard.limit-count.description': '在指定的时间范围内，限制总的请求次数',
  ...
  'component.pluginPage.pluginCard.limit-req.description': '限制请求速度的插件，基于漏桶算法',
  ...
  'component.pluginPage.pluginCard.cors.description': 'CORS 插件可以为服务端启用 CORS 的返回头',
  ...
  'component.pluginPage.pluginCard.prometheus.description':
    '提供符合 prometheus 数据格式的 metrics 数据',

  'component.pluginPage.pluginCard.proxy-cache.description': '代理缓存插件，缓存后端服务的响应数据',
  ...
  'PluginPage.card.proxy-cache.property.cache_key.extra': '可以使用 Nginx 变量，例如：$host, $uri',
  ...
  'component.pluginPage.pluginCard.proxy-mirror.description':
    'proxy mirror 代理镜像插件，提供了镜像客户端请求的能力',
  ...
  'component.pluginPage.pluginCard.syslog.description': '对接 syslog 日志服务器',
  ...
  'component.pluginPage.pluginCard.tcp-logger.description': '对接 TCP 日志服务器',
  ...
  'component.pluginPage.pluginCard.udp-logger.description': '对接 UDP 日志服务器',
  ...
  'component.pluginPage.pluginCard.zipkin.description': '对接 zipkin',
  ...
  'component.pluginPage.pluginCard.skywalking.description': '对接 Apache Skywalking',
  ...
  'component.pluginPage.pluginCard.basic-auth.description': 'basic auth 插件',
  'component.pluginPage.pluginCard.jwt-auth.description': 'JWT 认证插件',
  'component.pluginPage.pluginCard.key-auth.description': 'key auth 插件',
  'component.pluginPage.pluginCard.wolf-rbac.description': '对接 wolf RBAC 服务',
  'component.pluginPage.pluginCard.openid-connect.description':
    'Open ID Connect(OIDC) 插件提供对接外部认证服务的能力',

  'component.pluginPage.pluginCard.redirect.description': '重定向插件',
  'component.pluginPage.pluginCard.proxy-rewrite.description':
    'proxy rewrite 代理改写插件，可以改写客户端请求',
  ...
  'component.pluginPage.pluginCard.node-status.description': '节点状态',
  'component.pluginPage.pluginCard.defaultMessage': '请查阅官方文档',

  'component.pluginPage.drawer.title.configurePlugin': '配置插件',
  'component.pluginPage.button.disable': '禁用',
  'component.pluginPage.button.enable': '启用',
  'component.pluginPage.panelSection.title.isEnabled': '已启用',
  'component.pluginPage.panelSection.title.notEnabled': '未启用',
};
